    ...
    <div className="space-y-8 py-8 animate-in fade-in duration-700">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="bg-slate-50 border border-slate-200 rounded-xl py-2 pl-10 pr-4 text-xs font-mono focus:border-blue-500/50 outline-none w-64 transition-all text-foreground placeholder:text-black"
            />
          </div>
          <button 
          ...
          <button 
            ...
            className="p-2 border border-slate-200 rounded-xl text-black hover:text-blue-600 hover:bg-slate-50 transition-all"
            title="Refresh Data"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
        <div className="bg-white p-6 rounded-2xl flex items-center justify-between border-l-4 border-amber-500 shadow-sm border-y border-r border-slate-100">
          <div>
            <p className="text-[9px] text-black uppercase tracking-widest mb-1 font-black">Total Assets Value</p>
        ...
        <div className="bg-white p-6 rounded-2xl flex items-center justify-between border-l-4 border-teal-500 shadow-sm border-y border-r border-slate-100">
          <div>
            <p className="text-[9px] text-black uppercase tracking-widest mb-1 font-black">Ready Units</p>
        ...
        <div className="bg-white p-6 rounded-2xl flex items-center justify-between border-l-4 border-blue-500 shadow-sm border-y border-r border-slate-100">
          <div>
            <p className="text-[9px] text-black uppercase tracking-widest mb-1 font-black">In Service</p>
      ...
      {loading && vehicles.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 gap-4 border border-dashed border-slate-200 rounded-2xl bg-slate-50/50">
          ...
          <p className="text-[10px] uppercase tracking-[0.3em] text-black font-mono">Syncing Asset Ledger...</p>
        </div>
      ) : (
      ...
      {!loading && filteredVehicles.length === 0 && (
        <div className="text-center py-20 bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
          <p className="text-black font-mono tracking-widest uppercase text-[10px]">No vehicles found matching search parameters</p>
        </div>
      )}
