  ...
  return (
    <div className={`bg-white p-8 rounded-3xl border border-slate-200 relative overflow-hidden transition-all duration-500 shadow-sm`}>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <h3 className="text-sm font-black uppercase tracking-[0.3em] text-foreground">Invoice Protocol</h3>
      </div>
      ...
      <div className="space-y-6">
        <div className="space-y-3">
          ...
          <select 
            ...
            className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-6 text-sm font-black text-foreground focus:border-blue-500/50 outline-none appearance-none cursor-pointer transition-all"
          >
            <option value="" className="bg-white">Select Registry Code...</option>
        ...
        <button 
          ...
          className="w-full py-5 rounded-2xl bg-blue-600 text-white text-[10px] font-black uppercase tracking-[0.4em] hover:bg-blue-700 transition-all flex items-center justify-center gap-3 shadow-xl shadow-blue-100 active:scale-[0.98] disabled:opacity-50"
        >
          {loading ? (
