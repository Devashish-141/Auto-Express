    ...
    <div className="bg-white border border-slate-200 rounded-3xl p-6 relative overflow-hidden h-[210px] flex flex-col shadow-sm">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-between">
        <div className="flex items-center justify-between py-3 border-b border-slate-100">
          <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Total Acquired</span>
          <span className="text-sm text-slate-900 font-black font-mono">{stats.count}</span>
        </div>
        <div className="flex items-center justify-between py-3 border-b border-slate-100">
        ...
        <div className="flex items-center justify-between py-3">
          <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Inventory Turn</span>
          <span className="text-sm text-slate-900 font-black font-mono">{stats.turn}</span>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-white border border-slate-200 rounded-3xl p-6 relative overflow-hidden flex-1 flex flex-col mt-6 shadow-sm">
      ...
      <div className="relative z-10 flex items-center justify-between mt-8 pt-6 border-t border-slate-100">
        ...
        <div className="text-center w-full border-l border-slate-100">
          ...
          <p className="text-sm text-slate-900 font-black font-mono">{totals.turn}</p>
        </div>
      </div>
    </div>
  );
