...
export default function DealDetailPage() {
  ...
  if (!deal) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-4">
        <p className="text-black uppercase tracking-widest font-bold">Deal not found</p>
  ...
  const stageColors: Record<string, string> = {
    ...
    closed: 'border-gray-500/30 text-black bg-gray-500/10',
  };
      ...
      <main className="flex-1 p-6 overflow-y-auto">
        <div className="max-w-[1200px] mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex items-center justify-between">
            <Link 
              href="/"
              className="flex items-center gap-2 text-black hover:text-blue-600 transition-colors text-xs uppercase tracking-widest font-bold"
            >
              <ChevronLeft size={16} />
              Back to Dashboard
            </Link>
            ...
            <div className="flex items-center gap-3">
              <span className="text-[10px] uppercase tracking-[0.2em] text-black">Deal Stage:</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className={`glass-card p-8 relative overflow-hidden ${isClosed ? 'opacity-90' : ''}`}>
                ...
                <div className="flex items-start justify-between mb-8">
                  <div>
                    ...
                    <p className="font-mono text-black text-sm tracking-widest">{dealId}</p>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-8 py-8 border-y border-white/5">
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-black mb-4">Customer Details</p>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-black">Rep: {deal.rep_code}</p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-black mb-4">Vehicle Identity</p>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-black font-mono">{deal.vehicle?.vin}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 space-y-12">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      <h3 className="text-xs uppercase tracking-widest text-black">Finance Application Pipeline</h3>
            ...
            <div className="space-y-6">
              ...
              <div className={`glass-card p-6 border border-teal-500/20 bg-teal-500/5 shadow-[0_0_40px_rgba(20,184,166,0.05)]`}>
                ...
                <p className="text-[10px] text-black mb-6 leading-relaxed uppercase tracking-wider">
                ...
                {!isRegistered && !isClosed && (
                  <p className="mt-4 text-[8px] text-black text-center uppercase tracking-widest">
              ...
              <div className="glass-card p-6">
                <h4 className="text-xs uppercase tracking-widest text-black mb-6 font-bold">Financial Summary</h4>
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-[10px] uppercase tracking-widest text-black">Vehicle Price</span>
                    <span className="text-xs font-mono font-bold">€{deal.vehicle?.price?.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[10px] uppercase tracking-widest text-black">Payments Received</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-[10px] uppercase tracking-widest text-black">Finance Approved</span>
