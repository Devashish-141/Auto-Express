-- ============================================================
-- AUTO EXPRESS IRELAND — FULL DATABASE SCHEMA V2
-- Includes all initial tables, RLS policies, and new columns 
-- (transmission, fuel_type, registration_number, mileage as NUMERIC, etc.)
...
CREATE TABLE IF NOT EXISTS public.vehicles (
    ...
    created_by          TEXT            REFERENCES public.reps(rep_code),
    created_at          TIMESTAMPTZ     DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS public.deals (
    ...
    vrt_amount      DECIMAL(12, 2),
    reg_number      TEXT,
    finance_company_code TEXT,
...
DROP POLICY IF EXISTS "Reps can manage vehicles"           ON public.vehicles;
...
-- ============================================================
-- STEP 4: SEED DATA (Optional Base Data)
-- ============================================================
